        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-10">
          <div className="md:w-1/2">
            <div className="flex items-center mb-4">
              <FileText className="h-8 w-8 text-idia-600 ml-3" />
          ...
          <div className="md:w-1/2 bg-white p-6 rounded-xl shadow-md">
            <div className="grid grid-cols-2 gap-4 md:gap-6">
              <div className="text-center p-4 rounded-lg bg-idia-50">
                <h3 className="text-4xl font-bold text-idia-700 mb-1">۵+</h3>
                <p className="text-gray-600">سال تجربه</p>
              </div>
              <div className="text-center p-4 rounded-lg bg-idia-50">
                <h3 className="text-4xl font-bold text-idia-700 mb-1">۳۲K+</h3>
                <p className="text-gray-600">کاربر فعال</p>
              </div>
              <div className="text-center p-4 rounded-lg bg-idia-50">
                <h3 className="text-4xl font-bold text-idia-700 mb-1">۷+</h3>
                <p className="text-gray-600">متخصص در تیم</p>
              </div>
              <div className="text-center p-4 rounded-lg bg-idia-50">
                <h3 className="text-4xl font-bold text-idia-700 mb-1">۹۸%</h3>
